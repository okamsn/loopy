...
(ert-deftest iteration-sub-level ()
  (should-error (liq (if t (listing i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (if t (listing-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (if t (arraying i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (if t (arraying-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (if t (sequencing i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (if t (sequencing-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (if t (cycling 1)) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (when t (listing i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (when t (listing-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (when t (arraying i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (when t (arraying-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (when t (sequencing i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (when t (sequencing-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (when t (cycling 1)) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (unless t (listing i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (unless t (listing-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (unless t (arraying i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (unless t (arraying-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (unless t (sequencing i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (unless t (sequencing-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (unless t (cycling 1)) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (cond (t (listing i '(1)))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (cond (t (listing-ref i '(1)))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (cond (t (arraying i '(1)))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (cond (t (arraying-ref i '(1)))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (cond (t (sequencing i '(1)))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (cond (t (sequencing-ref i '(1)))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (cond (t (cycling 1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (progn (listing i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (progn (listing-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (progn (arraying i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (progn (arraying-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (progn (sequencing i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (progn (sequencing-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (liq (progn (cycling 1)) (finally-return t)) :type 'loopy-sub-level-iter))
