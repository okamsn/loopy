...
(ert-deftest iteration-sub-level ()
  (should-error (lq (if t (list i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (if t (list-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (if t (array i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (if t (array-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (if t (seq i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (if t (seq-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (if t (repeat 1)) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (when t (list i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (when t (list-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (when t (array i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (when t (array-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (when t (seq i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (when t (seq-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (when t (repeat 1)) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (unless t (list i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (unless t (list-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (unless t (array i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (unless t (array-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (unless t (seq i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (unless t (seq-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (unless t (repeat 1)) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (cond (t (list i '(1)))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (cond (t (list-ref i '(1)))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (cond (t (array i '(1)))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (cond (t (array-ref i '(1)))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (cond (t (seq i '(1)))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (cond (t (seq-ref i '(1)))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (cond (t (repeat 1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (group (list i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (group (list-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (group (array i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (group (array-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (group (seq i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (group (seq-ref i '(1))) (finally-return t)) :type 'loopy-sub-level-iter)
  (should-error (lq (group (repeat 1)) (finally-return t)) :type 'loopy-sub-level-iter))
