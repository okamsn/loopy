...
(loopy-deftest optimized-named-vars-collect-adjoin ()
  :result '(1 2 3)
  :body ((accum-opt coll)
         (array i [1 2 3])
         (_cmd coll i)
         (finally-return coll))
  :loopy ((_cmd . (collect adjoin)))
  :iter-bare ((array . arraying)
              (_cmd . (collecting adjoining)))
  :iter-keyword ((_cmd . (collect adjoin))
                 (array . array))
  :repeat _cmd)

(loopy-deftest optimized-named-vars-append-nconc ()
  :result '(1 2 2 3 3 4)
  :body ((accum-opt coll)
         ...
         (_cmd coll i)
         (finally-return coll))
  :loopy ((_cmd . (append nconc)))
  :iter-bare ((array . arraying)
              (_cmd . (appending nconcing)))
  :iter-keyword ((_cmd . (append nconc))
                 (array . array))
  :repeat _cmd)

(loopy-deftest optimized-named-vars-union-nunion ()
  :result '(1 2 3 4)
  :body ((accum-opt coll)
         (array i (vector (list 1 2)
                          (list 2 3)
         ...
         (_cmd coll i)
         (finally-return coll))
  :loopy ((_cmd . (union nunion)))
  :iter-bare ((array . arraying)
              (_cmd . (unioning nunioning)))
  :iter-keyword ((_cmd . (union nunion))
                 (array . array))
  :repeat _cmd)

(loopy-deftest optimized-named-vars-concat ()
  :result "abcdef"
  :body ((accum-opt coll)
         (array i ["ab" "cd" "ef"])
         (concat coll i)
...
(loopy-deftest optimized-named-vars-vconcat ()
  :result [1 2 2 3 3 4]
  :body ((accum-opt coll)
         (array i (vector (list 1 2)
                          (list 2 3)
...
(loopy-deftest optimized-named-vars-collect-adjoin-with-pos-end ()
  :result '(1 2 3)
...
(loopy-deftest optimized-named-vars-append-nconc-with-pos-end ()
  :result '(1 2 2 3 3 4)
  :body ((accum-opt (coll end))
         (array i (vector (list 1 2)
                          (list 2 3)
...
(loopy-deftest optimized-named-vars-union-nunion-with-pos-end ()
  :result '(1 2 3 4)
  :body ((accum-opt (coll end))
         (array i (vector (list 1 2)
                          (list 2 3)
...
(loopy-deftest optimized-named-vars-concat-with-pos-end ()
  :result "abcdef"
  :body ((accum-opt (coll end))
         (array i ["ab" "cd" "ef"])
         (concat coll i)
...
(loopy-deftest optimized-named-vars-vconcat-with-pos-end ()
  :result [1 2 2 3 3 4]
  :body ((accum-opt (coll end))
         (array i (vector (list 1 2)
                          (list 2 3)
  ...
  :iter-keyword (array vconcat))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(loopy-deftest optimized-named-vars-collect-adjoin-with-pos-beginning ()
  :result '(1 2 3)
  :body ((accum-opt (coll beginning))
         (array i [1 2 3])
         (_cmd coll i)
         (finally-return coll))
  :loopy ((_cmd . (collect adjoin)))
...
(loopy-deftest optimized-named-vars-append-nconc-with-pos-beginning ()
  :result '(1 2 2 3 3 4)
  :body ((accum-opt (coll beginning))
         (array i (vector (list 1 2)
                          (list 2 3)
...
(loopy-deftest optimized-named-vars-union-nunion-with-pos-beginning ()
  :result '(1 2 3 4)
  :body ((accum-opt (coll beginning))
         (array i (vector (list 1 2)
                          (list 2 3)
...
(loopy-deftest optimized-named-vars-concat-with-pos-beginning ()
  :result "abcdef"
  :body ((accum-opt (coll beginning))
         (array i ["ab" "cd" "ef"])
         (concat coll i)
...
(loopy-deftest optimized-named-vars-vconcat-with-pos-beginning ()
  :result [1 2 2 3 3 4]
  :body ((accum-opt (coll beginning))
         (array i (vector (list 1 2)
                          (list 2 3)
...
(loopy-deftest optimized-named-vars-collect-adjoin-with-pos-start ()
  :result '(1 2 3)
...
(loopy-deftest optimized-named-vars-append-nconc-with-pos-start ()
  :result '(1 2 2 3 3 4)
  :body ((accum-opt (coll start))
         (array i (vector (list 1 2)
                          (list 2 3)
...
(loopy-deftest optimized-named-vars-union-nunion-with-pos-start ()
  :result '(1 2 3 4)
  :body ((accum-opt (coll start))
         (array i (vector (list 1 2)
                          (list 2 3)
...
(loopy-deftest optimized-named-vars-concat-with-pos-start ()
  :result "abcdef"
  :body ((accum-opt (coll start))
         (array i ["ab" "cd" "ef"])
         (concat coll i)
...
(loopy-deftest optimized-named-vars-vconcat-with-pos-start ()
  :result [1 2 2 3 3 4]
  :body ((accum-opt (coll start))
         (array i (vector (list 1 2)
                          (list 2 3)
